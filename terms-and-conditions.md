# *Terms & Conditions*
**Updated 8th of February 2023**

## General Terms

By accessing and placing an order with dhakira, you confirm you are in agreement with and bound to the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and dhakira.

Under no circumstances shall dhakira team be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data of profit, arising out of the use, or the inability to use, the materials on this site, even if dhakira team or an authorized representative has been advised of the possibility of such damages. If your use of materials from this site results in the need for servicing, repair or correction of equipment or data, you assume any costs thereof.

dhakira will note be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to change prices and revise the resources usage policy at any moment.

## License

dhakira grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use the app and web app strictly in accordance with the terms of this Agreement. These Terms & Conditions are a contract between you and dhakira (“we”, “our”, or “us”) grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use the app and web app strictly in accordance with the terms of this Agreement.

## Definitions and key terms
For this Terms & Conditions:

- Cookie: small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.
- Company: when this policy mentions “COmpany”, “we”, “us”, or “our” it refers to dhakira that is responsible for your information under this Privacy Policy.
- Country: where dhakira or the owners/founders of dhakira are based, in this case is Spain.
- Customer:refers to the company, organization or person that signs up to use the dhakira service to manage the relationships with your consumers or service users.
- Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit dhakira and use the services.
...
- Personnel: refers to those individuals who are employed by dhakira or are under contract to perform a service on behalf of one of the parties.
...
- Service: refers to the service provided by dhakira as described in the relative terms (if available) and on this platform.
- Third-party service: refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.
- Website: dhakira’s site, hitch can be accessed via this URL: {{}}.
- You: a person or entity that is registered with dhakira to use the services.
...
This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR dhakira’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action, or other controversy between you and us concerning the Services or this agreement, whether in contract, warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. “Dispute” will be given the broadest possible meaning allowable under law.
...
Don't hesitate to contact us if you have any questions to dhakiraapp@dhakirappteam.com
